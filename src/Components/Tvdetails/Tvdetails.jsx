...
export default function Tvdetails() {
    ...
    return <>
        <Helmet>
            <title>{itemdetails.original_name}</title>
        </Helmet>
            ...
            {itemdetails.poster_path !== undefined ?             <div className="row">
                ...
                <div className={` col-sm-12 col-md-7 col-lg-7 ${style.right}`}>
                    <div className="text-white ">
                        <h1 className="fs-4 mb-4"><span className="fw-bold fs-4 ">Tv show Name :</span>  <span className={`${style.special}`}>{itemdetails.original_name}</span></h1>
                        <p className="mb-4"> <span className="fw-bold fs-4 ">Over view :</span> <span className={`${style.special}`}>{itemdetails.overview}</span></p>
                        <p className="mb-4">  <span className="fw-bold fs-4 ">Date : </span><span className={`${style.special}`}>{itemdetails.last_air_date}</span></p>
